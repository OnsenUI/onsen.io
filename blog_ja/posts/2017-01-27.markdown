...
Formstoneを使う際には機能毎に用意されているjs/cssファイルを読み込む方法と、全体をまとめたjs/cssファイルを読み込む方法の2種類があります。今回は全部がまとまっている[site.js](https://raw.githubusercontent.com/moongift/monaca-with-formstone/master/www/js/site.js)と[site.css](https://raw.githubusercontent.com/moongift/monaca-with-formstone/master/www/css/site.css)を使います。FormstoneにはjQueryが必須ですが、site.jsの中に含まれています。
