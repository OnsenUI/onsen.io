...
As mentioned before, this was just one way to integrate Onsen UI with *ui-router*. Have you found useful this post or you have any suggestion related to *ui-router* and Onsen UI? Please leave your impressions in the comments if you feel like. Since *ui-router* is a great module and we would like to support it better, some updates to Onsen UI could come in next versions related to this topic. Stay tuned!
