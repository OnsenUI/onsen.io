...
Vue hybrid apps are now possible with [Onsen UI & Monaca Toolkit](https://onsen.io/getting-started/). As mentioned in the [last blog post](/blog/vue-template-release/), Monaca CLI & Localkit have been updated to include Vue templates. This gives you a Cordova app template prepared to work with Onsen UI and Vue. Furthermore, it will be soon updated to support Webpack v2 (stay tunned!).
