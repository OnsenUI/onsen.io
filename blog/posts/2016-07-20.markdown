...
The entire source code of the app is available at [GitHub](https://github.com/philolo1/Horizon-MobX-OnsenUI). You can try out the app [here](http://192.81.214.88:5000/Horizon-MobX-OnsenUI/build/index.html).
