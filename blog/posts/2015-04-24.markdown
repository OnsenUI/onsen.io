...
In this tutorial we we'll take a look at the API and implement a simple component.

<!-- more -->

Although all parts of the Web Components specification hasn't been implemented in all browsers yet, there are polyfills that add the functionality to all modern browsers.
...
The component we're going to implement is a "favorite star". You know the kind of star that can be found all over the web and you can click to show that you like something.
