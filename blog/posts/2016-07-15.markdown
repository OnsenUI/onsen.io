...
<div style="display: flex; margin: 40px 0;" >
  ...
  <div style="background-image: url('/blog/content/images/2016/Feb/iphone6.png'); width: 401px; height: 806px; ">
    <iframe scrolling="yes" style="margin-top: 92px; margin-left: 26px;" src="http://192.81.214.88:8181/Horizon-MobX-OnsenUI/build/index.html" width="349" height="617" scrolling="no" class="lazy-hidden"></iframe>
  </div>
  <div style="flex-grow: 1;"> </div>
</div>
...
In the following explaination we will only explain the structure and the basic interaction of the components, the curious reader can look the details up at [GitHub](https://github.com/philolo1/Horizon-MobX-OnsenUI).
...
The LoginPage consits of an image, two inputs and a button. The application state is passed down to the component and updating is very simple, as can be seen on the UserInput:
...
Ones the value changes, we just update the variable and MobX will automatically rerender the UserInput compoent and only this component, since the userName is only displayed there.
