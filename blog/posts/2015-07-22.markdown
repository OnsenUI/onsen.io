...
title: "Tutorial: Make a YouTube app with AngularJS and Onsen UI"
...
Like these events, there are many other features in YouTube API v3 that you can discover in the docs:
