...
For these and other implementation details we are preparing some timely documentation that will come in handy if you have doubts. We will publish the link once it is ready, hopefully within the next few days.
