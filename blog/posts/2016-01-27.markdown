...
[Foursquare API](https://developer.foursquare.com/docs/) gives us access to a huge database of different venues from all around the world. It includes a rich variety of information such the place's addresses, popularity, tips and photos. The access to the API is available for free and provides an easy setup.
