      ...
      <OnsNavigator
        ...
        renderScene={(route, navigator) =>
          <OnsPage>
            ...
            <p>
              <OnsButton onClick={navigator.pushPage.bind(navigator, {
                title: 'Another page',
...
There is nothing stopping us from combining the OnsTabbar and the OnsNavigator component in the same app to enable more complex navigation. In the demo below we have an OnsNavigator component where the first page in the stack is an OnsTabbar component. Using the navigator we can push pages on top of the tabbar:
...
This is easy to achieve by putting the OnsTabbar inside the OnsNavigator.
