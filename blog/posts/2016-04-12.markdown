...
All the source code is if freely available at [https://github.com/philolo1/OnsenUI-redux-calculator/](https://github.com/philolo1/OnsenUI-redux-calculator/).
...
There is now real magic going on here. Every row is split equally accross the screen and every column has equal height using flexbox and percentages. The colors of the buttons are done by different opacity. CSS contains only a few lines of code:
