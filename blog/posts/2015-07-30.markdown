...
If you have any question about the content of the article please write a comment below. In the case you found some mistake or you would like to improve the content, feel free to make a pull request to the [website repository](https://github.com/OnsenUI/onsen.io/tree/master/blog/posts). We appreciate all kinds of feedback!
