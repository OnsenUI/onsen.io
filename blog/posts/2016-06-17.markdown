...
author: patrick
date: 2016-06-17
id: "mobx-react-stopwatch"
title: "Its all about time: Building a performant Stopwatch with MobX - fast"
category: tutorial
...
MobX is great framework to build apps fast and performant. The choice between Redux and MobX comes down to how much control we want to have about the application and how much we let our frameworks do the job. To learn more about MobX we can highly recommend this [video](https://www.youtube.com/watch?v=XGwuM_u7UeQ) and the [GitHub repository](https://github.com/mobxjs/mobx).
