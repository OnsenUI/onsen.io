...
We have just published an article on how to use the `Navigator` and `Tabbar` React components. Please take a look [here](/blog/react-onsen-ui-navigator-tabs) after reading this article.
...
<iframe width="320" height="568" style="box-shadow: 0 3px 6px rgba(0,0,0,0.16), 0 3px 6px rgba(0,0,0,0.23);" src="https://onsenui.github.io/react-onsenui-kitchensink/"></iframe>
